...
class Admin extends CI_Controller {
    ...
    public function header()
    {
        ...
        $head['navbar'] = "admin";
        $head['title'] = $this->title;
        $head['profile'] = (object) ["username"=>"Admin", "nama"=>"Admin WCU"];
    ...
    public function daftar()
    {
        ...
        $this->title = "Daftar Pengajuan Kegiatan";
        // print_r($data['view']);
        $this->header();
    ...
    public function user(){
        $username = $this->session->userdata('username');
        $data['view'] = $this->M_Akun->get_all_user()->result();
    ...
    public function delete_user(){
        $id = $this->input->post('id');
        $this->M_Akun->del_akun(array("username"=>$id));
        $this->M_Akun->del_profile(array("username"=>$id));
        $this->session->set_flashdata('info','<div class="alert alert-success" style="margin-top: 3px">
     <div class="header"><b><i class="fa fa-exclamation-circle"></i> SUCCESS</b> Data berhasil diahapus</div></div>' );
    ...
    public function akun(){
        ...
        $data['v'] = $this->M_Akun->get_user(array("tb_users.username"=>"$id"))->row();
    ...
    public function ganti_password(){
        ...
        $this->session->set_flashdata('info','<div class="alert alert-success" style="margin-top: 3px">
        <div class="header"><b><i class="fa fa-exclamation-circle"></i> SUCCESS</b> Data berhasil diubah</div></div>' );
        redirect(base_url('admin/user'));
    }
