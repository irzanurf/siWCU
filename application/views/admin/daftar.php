                <section id="line-awesome-icons">
                                        ...
                                        <div class="feather-icons overflow-hidden row">
                                            <div class="table-responsive"
                                                ...
                                                <form style="display:inline-block;" method="post"
                                                    action="<?= base_url('Admin/export');?>">
                                                    <button type="Submit" class="btn btn-success"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Export">
                                                        <i class="la la-download" style="color:white"></i>
                                                        Export Semua Pengajuan Kegiatan
                                                    </button>
                                                </form>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" class="btn btn-warning"
                                                                    style="text-align: center" data-bs-toggle="tooltip"
                                                                ...
                                                                <form style="display:inline-block;" method="post"
                                                                    action="<?= base_url('admin/edit_kegiatan');?>">
                                                                    <input type='hidden' name="id"
                                                                        value="<?= $v->id ?>">
                                                                ...
                                                                <form style="display:inline-block;" method="post"
                                                                    ...
                                                                    action="<?= base_url('admin/delete_kegiatan');?>">
                                                                    <input type='hidden' name="id"
                                                                        value="<?= $v->id ?>">
                    ...
                    <!-- modal tambah data -->
                    <d class="modal fade tambah-data" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form role="form" method="post" action="<?= base_url('User/insert_kegiatan');?>"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label>Jenis Kegiatan</label><label style="color:red; font-size:12px;">
                                            (*Wajib diisi)</label>
                                        <select class="form-control" onchange="checkJenis(this)" id="jenis"
                                            name="jenis">
                                        ...
                                        <label>Judul Kegiatan</label><label style="color:red; font-size:12px;">
                                            (*Wajib diisi)</label>
                            ...
                            Tambah data professor</button><br> -->
                                            <label>Jumlah Data Prof</label><label style="color:red; font-size:12px;">
                                                (*Wajib
                                                diisi)</label>
                        ...
                        $('#jumlah').keyup(function() {
                            ...
                            for (var jum = 1; jum <= jumlah; jum++) {
                                $('<div class="accordion" id="accordion" style="background:#00000;"><div class="card"><div class="card-header" id="headingOne"><div class="form-group row"><div class="col-12"><button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapse' +
                                    jum +
                                    '" aria-expanded="true" aria-controls="collapseOne">> Data Professor ' +
                                    jum +
                        ...
                        function checkJenis(select) {
                            ...
                            if (select.options[select.selectedIndex].value == "1" || select.options[select
                                    .selectedIndex]
                                .value == "2") {
