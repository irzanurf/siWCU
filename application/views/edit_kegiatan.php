                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data"
                            ...
                            <?php if(!empty($ext)){ ?>
                                    ...
                                    <div class="card"
                                        ...
                                        <div id="collapse1" class="collapse hide" aria-labelledby="headingOne"
                                            ...
                                            <label>Titel</label><label style="color:red;font-size:12px;">(*Wajib
                                                ...
                                                <option value="">Please Select</option>
                                                <option value="Prof"
                                                    <?php if($ext[0]->titel=="Prof") echo 'selected="selected"'; ?>>Prof
                                                </option>
                                                <option value="Dr"
                                                    <?php if($ext[0]->titel=="Dr") echo 'selected="selected"'; ?>>Dr
                                                </option>
                                                <option value="Mr"
                                                    <?php if($ext[0]->titel=="Mr") echo 'selected="selected"'; ?>>Mr
                                                </option>
                                                <option value="Mrs"
                                                    <?php if($ext[0]->titel=="Mrs") echo 'selected="selected"'; ?>>Mrs
                                                </option>
                                                <option value="Ms"
                                                    <?php if($ext[0]->titel=="Ms") echo 'selected="selected"'; ?>>Ms
                                                </option>
                                            </select>
                                            <hr><label id="l_nama_depan">Nama Depan</label><label
                                                ...
                                                value="<?=$ext[0]->nama_depan?>"><br><label id="l_nama_belakang">Nama
                                                Belakang</label><label style="color:red;font-size:12px;">(*Wajib
                                                diisi)</label><input name="nama_belakang[]" id="nama_belakang"
                                                class="form-control" value="<?=$ext[0]->nama_belakang?>"><br><label
                                                id="l_jabatan">Jabatan</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="jabatan[]" id="jabatan" class="form-control"
                                                value="<?=$ext[0]->jabatan?>"><br><label
                                                id="l_kepakaran">Kepakaran</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="kepakaran[]" id="kepakaran" class="form-control"
                                                value="<?=$ext[0]->kepakaran?>"><br><label
                                                id="l_departemen">Departemen</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="departemen[]" id="departemen" class="form-control"
                                                value="<?=$ext[0]->departemen?>"><br><label
                                                id="l_universitas">Universitas</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="universitas[]" id="universitas" class="form-control"
                                                value="<?=$ext[0]->universitas?>"><br><label
                                                id="l_negara">Negara</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="negara[]" id="negara" class="form-control"
                                                value="<?=$ext[0]->negara?>"><br><label id="l_email">Email</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                    ...
                                    <div class="card"
                                        ...
                                        <div id="collapse1" class="collapse hide" aria-labelledby="headingOne"
                                            ...
                                            <hr><label id="l_nama_depan">Nama Depan</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="nama_depan[]" id="nama_depan" class="form-control"
                                                value=""><br><label id="l_nama_belakang">Nama
                                                Belakang</label><label style="color:red;font-size:12px;">(*Wajib
                                                diisi)</label><input name="nama_belakang[]" id="nama_belakang"
                                                ...
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="negara[]" id="negara" class="form-control"
                                                value=""><br><label id="l_email">Email</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="email[]" id="email" type="email" class="form-control"
                                                value="">
                                        </div>
                                ...
                                <?php for($i=1; $i<count($ext); $i++) { ?>
                                <div class="accordion" id="accordion<?=$i+1?>">
                                    <div class="card"
                                        style="background-color:#f6f5f5; padding-left:1rem; padding-right:1rem;">
                                        <div class="card-header" style="padding-right: 0px; padding-left: 0px;"
                                            id="headingOne">
                                            <div class="form-group row">
                                                <div class="col-8"><button class="btn btn-link btn-block text-left"
                                                        type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#collapse<?=$i+1?>" aria-expanded="true"
                                                        aria-controls="collapseOne"><span class="prof">> Data
                                                            Professor <?=$i+1?></span></button>
                                                </div>
                                                <div class="col-4">
                                                    <button class="btn-sm btn-danger remove" style="float: right;"
                                                        type="button" id="removeItem<?=$i+1?>"
                                                        action="javascript:;"><b><i class="la la-trash"
                                                                style="color:white"></i></b></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="collapse<?=$i+1?>" class="collapse hide" aria-labelledby="headingOne"
                                            data-bs-parent="#accordion">
                                            <label>Titel</label><label style="color:red;font-size:12px;">(*Wajib
                                                diisi)</label><select class="form-control" name="titel[]" id="titel">
                                                <option value="">Please Select</option>
                                                <option value="Prof"
                                                    <?php if($ext[$i]->titel=="Prof") echo 'selected="selected"'; ?>>
                                                    Prof
                                                </option>
                                                <option value="Dr"
                                                    <?php if($ext[$i]->titel=="Dr") echo 'selected="selected"'; ?>>
                                                    Dr
                                                </option>
                                                <option value="Mr"
                                                    <?php if($ext[$i]->titel=="Mr") echo 'selected="selected"'; ?>>
                                                    Mr
                                                </option>
                                                <option value="Mrs"
                                                    <?php if($ext[$i]->titel=="Mrs") echo 'selected="selected"'; ?>>
                                                    Mrs
                                                </option>
                                                <option value="Ms"
                                                    <?php if($ext[$i]->titel=="Ms") echo 'selected="selected"'; ?>>
                                                    Ms
                                                </option>
                                            </select>
                                            <hr><label id="l_nama_depan">Nama Depan</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="nama_depan[]" id="nama_depan" class="form-control"
                                                value="<?=$ext[$i]->nama_depan?>"><br><label id="l_nama_belakang">Nama
                                                Belakang</label><label style="color:red;font-size:12px;">(*Wajib
                                                diisi)</label><input name="nama_belakang[]" id="nama_belakang"
                                                class="form-control" value="<?=$ext[$i]->nama_belakang?>"><br><label
                                                id="l_jabatan">Jabatan</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="jabatan[]" id="jabatan" class="form-control"
                                                value="<?=$ext[$i]->jabatan?>"><br><label
                                                id="l_kepakaran">Kepakaran</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="kepakaran[]" id="kepakaran" class="form-control"
                                                value="<?=$ext[$i]->kepakaran?>"><br><label
                                                id="l_departemen">Departemen</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="departemen[]" id="departemen" class="form-control"
                                                value="<?=$ext[$i]->departemen?>"><br><label
                                                id="l_universitas">Universitas</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="universitas[]" id="universitas" class="form-control"
                                                value="<?=$ext[$i]->universitas?>"><br><label
                                                id="l_negara">Negara</label><label
                                                style="color:red;font-size:12px;">(*Wajib diisi)</label><input
                                                name="negara[]" id="negara" class="form-control"
                                                value="<?=$ext[$i]->negara?>"><br><label
