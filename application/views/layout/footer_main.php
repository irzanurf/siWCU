					    ...
					    <div class="container-xxl d-flex flex-column flex-md-row align-items-center justify-content-between">
					        ...
					        <div class="text-dark order-2 order-md-1">
					            <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
					                ...
					                <li class="menu-item">
					                    <a href="https://undip.ac.id/" target="_blank" class="menu-link px-2">Universitas
					                        Diponegoro</a>
					                </li>
					                <li class="menu-item">
					                    <a href="https://wcu.undip.ac.id" target="_blank" class="menu-link px-2">World Class
					                        University</a>
					                </li>
					            </ul>
					        </div>
					                            ...
					                            <div class="pe-3 mb-5">
					                                ...
					                                <div class="d-flex align-items-center mt-1 fs-6">
					                                    ...
					                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
					                                        ...
					                                        <img src="<?= base_url('assets/m/media/avatars/150-11.jpg');?>"
					                                            alt="img" />
					                                    </div>
					                                    <!--end::User-->
					                                </div>
					                            ...
					                            <div class="overflow-auto pb-5">
					                                ...
					                                <div
					                                    ...
					                                    <div
					                                        ...
					                                        <div class="symbol symbol-circle symbol-25px">
					                                            <img src="<?= base_url('assets/m/media/avatars/150-3.jpg');?>"
					                                                alt="img" />
					                                        </div>
					                                        <!--end::User-->
					                                        <!--begin::User-->
					                                ...
					                                <div
					                                    ...
					                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
					                                        <!--begin::User-->
					                                        <div class="symbol symbol-circle symbol-25px">
					                                            <img src="<?= base_url('assets/m/media/avatars/150-5.jpg');?>"
					                                                alt="img" />
					                                        </div>
					                                        <!--end::User-->
					                                        <!--begin::User-->
					                            ...
					                            <div class="overflow-auto pe-3">
					                                ...
					                                <div class="d-flex align-items-center mt-1 fs-6">
					                                    ...
					                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
					                                        ...
					                                        <img src="<?= base_url('assets/m/media/avatars/150-2.jpg');?>" alt="img" />
					                                    </div>
					                                    <!--end::User-->
					                                </div>
					                                <!--end::Description-->
					                            ...
					                            <div class="mb-5 pe-3">
					                                ...
					                                <div class="d-flex align-items-center mt-1 fs-6">
					                                    ...
					                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
					                                        ...
					                                        <img src="<?= base_url('assets/m/media/avatars/150-6.jpg');?>" alt="img" />
					                                    </div>
					                                    <!--end::User-->
					                                </div>
					                                <!--end::Description-->
					                                ...
					                                <div
					                                    ...
					                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
					                                        ...
					                                        <img alt="" class="w-30px me-3"
					                                            src="<?= base_url('assets/m/media/svg/files/pdf.svg');?>" />
					                                        <!--end::Icon-->
					                                        <!--begin::Info-->
					                                    ...
					                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
					                                        <!--begin::Icon-->
					                                        <img alt="" class="w-30px me-3"
					                                            src="<?= base_url('assets/m/media/svg/files/doc.svg');?>" />
					                                        <!--end::Icon-->
					                                        <!--begin::Info-->
					                                        <div class="ms-1 fw-bold">
					                                            <!--begin::Desc-->
					                                    ...
					                                    <div class="d-flex flex-aligns-center">
					                                        <!--begin::Icon-->
					                                        <img alt="" class="w-30px me-3"
					                                            src="<?= base_url('assets/m/media/svg/files/css.svg');?>" />
					                                        <!--end::Icon-->
					                                        <!--begin::Info-->
					                                        <div class="ms-1 fw-bold">
					                                            <!--begin::Desc-->
					                            ...
					                            <div class="pe-3 mb-5">
					                                ...
					                                <div class="d-flex align-items-center mt-1 fs-6">
					                                    ...
					                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
					                                        ...
					                                        <img src="<?= base_url('assets/m/media/avatars/150-3.jpg');?>" alt="img" />
					                                    </div>
					                                    <!--end::User-->
					                                </div>
					                                <!--end::Description-->
					                            ...
					                            <div class="overflow-auto pb-5">
					                                <div
					                                    ...
					                                    <div class="overlay me-10">
					                                        ...
					                                        <div class="overlay-wrapper">
					                                            <img alt="img" class="rounded w-100px"
					                                                src="<?= base_url('assets/m/media/stock/300x270/1.jpg');?>" />
					                                        </div>
					                                        <!--end::Image-->
					                                        <!--begin::Link-->
					                                    ...
					                                    <div class="overlay me-10">
					                                        ...
					                                        <div class="overlay-wrapper">
					                                            <img alt="img" class="rounded w-100px"
					                                                src="<?= base_url('assets/m/media/stock/300x270/2.jpg');?>" />
					                                        </div>
					                                        <!--end::Image-->
					                                        <!--begin::Link-->
					                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
					                                    ...
					                                    <div class="overlay">
					                                        ...
					                                        <div class="overlay-wrapper">
					                                            <img alt="img" class="rounded w-100px"
					                                                src="<?= base_url('assets/m/media/stock/300x270/3.jpg');?>" />
					                                        </div>
					                                        <!--end::Image-->
					                                        <!--begin::Link-->
					                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
					                            ...
					                            <div class="pe-3 mb-5">
					                                ...
					                                <div class="d-flex align-items-center mt-1 fs-6">
					                                    ...
					                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
					                                        ...
					                                        <img src="<?= base_url('assets/m/media/avatars/150-14.jpg');?>"
					                                            alt="img" />
					                                    </div>
					                                    <!--end::User-->
					                                </div>
					                                ...
					                                <div
					                                    ...
					                                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
					                                        ...
					                                        <div class="mb-3 mb-md-0 fw-bold">
					                                            ...
					                                            <div class="fs-6 text-gray-700 pe-7">Login into Rider Admin Dashboard
					...
					<!-- <button id="kt_explore_toggle"
					    ...
					    title="Jangan tinggalkan pengumuman penting disini" data-bs-toggle="tooltip" data-bs-placement="left"
					    data-bs-dismiss="click" data-bs-trigger="hover">
					    <span id="kt_explore_toggle_label">Announcement</span>
					</button> -->
					...
					<div id="kt_explore" class="explore bg-white" data-kt-drawer="true" data-kt-drawer-name="explore"
					    ...
					    <div class="card shadow-none rounded-0 w-100">
					        ...
					        <div class="card-header" id="kt_explore_header">
					            <h5 class="card-title fw-bold text-gray-600">Announcement</h5>
					            <div class="card-toolbar">
...
var hostUrl = "<?= base_url('/');?>";
					...
					<script src="<?= base_url('assets/m/plugins/global/plugins.bundle.js');?>"></script>
					<script src="<?= base_url('assets/m/js/scripts.bundle.js');?>"></script>
					<!--end::Global Javascript Bundle-->
					<!--begin::Page Vendors Javascript(used by this page)-->
					<script src="<?= base_url('assets/m/plugins/custom/fullcalendar/fullcalendar.bundle.js');?>"></script>
					<!--end::Page Vendors Javascript-->
					<!--begin::Page Custom Javascript(used by this page)-->
					<script src="<?= base_url('assets/m/js/custom/widgets.js');?>"></script>
