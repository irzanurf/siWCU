            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        <form>
                            <h2 style="text-align: center;">Approver</h2>
                            <hr>
                        ...
                        <form>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor1" name="skor1" onchange="Multiply()"
                                                    value="<?=$review[0]->skor?>" readonly> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                                            <td><input type="text" id="nilai1" name="nilai1"
                                                    value="<?=$review[0]->nilai?>" readonly></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><input type="text" id="skor1" name="skor1" value=""></td> -->
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor2" name="skor2" onchange="Multiply()"
                                                    value="<?=$review[1]->skor?>" readonly> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                                            <td><input type="text" id="nilai2" name="nilai2"
                                                    value="<?=$review[1]->nilai?>" readonly></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><input type="text" id="skor1" name="skor1" value=""></td> -->
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor3" name="skor3" onchange="Multiply()"
                                                    value="<?=$review[2]->skor?>" readonly> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                                            <td><input type="text" id="nilai3" name="nilai3"
                                                    value="<?=$review[2]->nilai?>" readonly></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><input type="text" id="skor1" name="skor1" value=""></td> -->
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor4" name="skor4" onchange="Multiply()"
                                                    value="<?=$review[3]->skor?>" readonly> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                                            <td><input type="text" id="nilai4" name="nilai4"
                                                    value="<?=$review[3]->nilai?>" readonly></td>
                                        </tr>

                                        <tr>
                                            <td colspan='4' style="text-align:center">Total</td>
                                            <td><input type="text" name="totalnilai" id="totalnilai"
                                                    value="<?=$komentar->nilai_total?>" readonly></td>
                                        </tr>
                            ...
                            <label>Total Anggaran Disetujui Reviewer</label><label style="color:red; font-size:12px;">
                                (*Wajib
                                diisi)</label>
                            <div class="form-group input-group">
                                <input size="4" maxlength="4" value="Rp." disabled="">
                                <input type="text" class="form-control currency" id="anggaran_disetujui"
                                    name="anggaran_disetujui" value="<?=$anggaran->anggaran?>" disabled="disabled">
                                <input size="3" maxlength="3" value=",00" disabled="">
                            </div><br>
                            ...
                            <h2>Form Komentar Komentator</h2>
                            <div class="form-group">
                                <label><br>Komentar Komentator</label><label style="color:red; font-size:12px;">
                                    (*Wajib diisi)</label>
                                <div>
                                    <textarea class="form-control" name="komentar" rows="3"
                                        readonly><?php if(!empty($comments->komentar)){echo"$comments->komentar";} else{};?></textarea>
                                </div>
                            </div><br>
                            <div class="text-center">
                                <button class="btn btn-success" type="button" data-bs-toggle="modal"
                                    data-bs-target=".rekomendasi"><i class="la la-balance-scale"></i> Beri Rekomendasi
                                </button>
                            </div>
                        </form>

                        <!-- modal tambah data -->
                        <div class="modal fade rekomendasi" tabindex="-1" role="dialog"
                            aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title h4" id="myLargeModalLabel">Rekomendasi</h5>
                                        <div class="btn btn-icon btn-sm btn-active-primary ms-2"
                                            data-bs-dismiss="modal" aria-label="Close">
                                            <i class="la la-close" style="color:black"></i>
                                        </div>
                                    </div>
                                    <form role="form" method="post" action="<?= base_url('Approver/rekomendasi');?>"
                                        enctype="multipart/form-data">
                                        <div class="modal-body">

                                            <input type="hidden" class="form-control" name="id"
                                                value=<?= $kegiatan->id?>>
                                            <input type="hidden" class="form-control" name="id_komentar"
                                                value=<?= $komentar->id?>>
                                            <label><br>Komentar Approval</label><label
                                            ...
                                            <div class="row" style="text-align:center">
                                                <div class="col-lg-3 col-md-3 col-sm-6">
                                                    <button type="submit" class="btn btn-outline-success"
                                                        name="keputusan" value="1">
                                                        <img class="profile-img-card"
                                                            src="<?php echo base_url('assets/condition1.png'); ?>"
                                                            width="130" height="110">
                                                    </button>
                                                    <label style="text-align:center">Diterima</label>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-6">
                                                    <button type="submit" class="btn btn-outline-primary"
                                                        name="keputusan" value="2">
                                                        <img class="profile-img-card"
                                                            src="<?php echo base_url('assets/condition2.png'); ?>"
                                                            width="130" height="110">
                                                    </button>
                                                    <label style="text-align:center">Diterima dengan perbaikan (maksimal
                                                        1 minggu)</label>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-6">
                                                    <button type="submit" class="btn btn-outline-warning"
                                                        name="keputusan" value="3">
                                                        <img class="profile-img-card"
                                                            src="<?php echo base_url('assets/condition3.png'); ?>"
                                                            width="130" height="110">
                                                    </button>
                                                    <label style="text-align:center">Dipertimbangkan untuk batch
                                                        selanjutnya</label>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-6">
                                                    <button type="submit" class="btn btn-outline-danger"
                                                        name="keputusan" value="4">
                                                        <img class="profile-img-card"
                                                            src="<?php echo base_url('assets/condition4.png'); ?>"
                                                            width="130" height="110">
                                                    </button>
                                                    <label style="text-align:center">Ditolak</label>
                                                </div>
                                            </div>
                                        </div>
