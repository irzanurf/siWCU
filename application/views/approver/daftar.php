                                    ...
                                    foreach($view as $v) { 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form style="display:inline-block;" method="post"
                                                    action="<?= base_url('approver/detail');?>">
                                                ...
                                                <form style="display:inline-block;" method="post"
                                                    action="<?= base_url('approver/edit_kegiatan');?>">
                                                    <input type='hidden' name="id" value="<?= $v->id ?>">
                                                ...
                                                <form style="display:inline-block;" method="post"
                                                    ...
                                                    action="<?= base_url('approver/delete_kegiatan');?>">
                                                    <input type='hidden' name="id" value="<?= $v->id ?>">
                                                ...
                                                <form style="display:inline-block;" data-bs-toggle="tooltip"
                                                    method="post" data-bs-placement="bottom" title="Approve"
                                                    action="<?= base_url('Approver/approve');?>">
                                                    <input type='hidden' name="id" value="<?= $v->id ?>">
                                                    <button class="btn btn-primary" style="color:grey" type="submit">
                                                        <i class="la la-balance-scale"
                                                            style="color:white; font-size:20px;"></i>
                                                    </button>
                                                </form>
                                                <?php } elseif($v->status == 3) { ?>
                                                <form style="display:inline-block;" method="post"
                                                    action="<?= base_url('approver/monev');?>">
                                                    <input type='hidden' name="id" value="<?= $v->id ?>">
                                                ...
                                                <?php } ?>
                                                <?php if(!empty($v->keputusan)) { ?>
                                                <form style="display:inline-block;" method="post"
                                                    onclick="return confirm('Apakah Anda Yakin Ingin Membatalkan Approver?');"
                                                    action="<?= base_url('approver/cancel');?>">
                                                    <input type='hidden' name="id" value="<?= $v->id ?>">
                                                    <button type="Submit" class="btn btn-danger"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
