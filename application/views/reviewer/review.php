            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        <form>
                            <h2 style="text-align: center;">Review Kegiatan</h2>
                            <hr>
                            <label>Jenis Kegiatan</label><label style="color:red; font-size:12px;"> (*Wajib
                                diisi)</label>
                            <select class="form-control rev" onchange="checkJenis(this)" id="jenis" name="jenis"
                                disabled="">
                        ...
                        <?php endif; ?>
                        <form role="form" method="post" action="<?= base_url('Reviewer/insertReview');?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor1" name="skor1" onchange="Multiply()" required=""> <a
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><input type="text" id="skor1" name="skor1" value=""></td> -->
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor2" name="skor2" onchange="Multiply()" required=""> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><input type="text" id="skor1" name="skor1" value=""></td> -->
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor3" name="skor3" onchange="Multiply()" required=""> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><input type="text" id="skor1" name="skor1" value=""></td> -->
                                            <td><input placeholder="Skor" type="number" step="any" min="0" max="100"
                                                    id="skor4" name="skor4" onchange="Multiply()" required=""> <a
                                                    href="javascript: void(0)" onChange="calc()"></a></td>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" class="form-control currency" id="anggaran_disetujui"
                                    name="anggaran_disetujui" value="0"
                                    required="">
                                <input size="3" maxlength="3" value=",00" disabled="">
                            </div><br>
